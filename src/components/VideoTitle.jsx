  ...
  return (
    <div className='pt-[15%] px-6 md:px-24 absolute w-screen aspect-video text-white bg-gradient-to-r from-black'>
        ...
        <div className='my-4 md:my-0'>
            ...
            <button className='hidden md:inline-block bg-gray-500 text-white lg:px-10 lg:p-4 rounded-md mx-2 bg-opacity-50 text-xl font-bold hover:bg-opacity-80'>More Info</button>
        </div>
    </div>
  )
}
